    ...
    xsi:schemaLocation="http://inspire.ec.europa.eu/schemas/ef/4.0 http://inspire.ec.europa.eu/schemas/ef/4.0/EnvironmentalMonitoringFacilities.xsd">
     <gml:featureMember>
         <ef:EnvironmentalMonitoringFacility gml:id="Piezometre.00026X0040.P1.2">
            ...
            <ef:legalBackground/>
            <ef:geometry>
                <gml:Point gml:id="Piezometre.geom.2.00026X0040-P1" srsDimension="2" srsName="urn:ogc:def:crs:EPSG::4326">
     ...
     <gml:featureMember><ef:EnvironmentalMonitoringFacility gml:id="Piezometre.00027X0043.PZ3.2">
            ...
            <ef:legalBackground/>
            <ef:geometry>
                <gml:Point gml:id="Piezometre.geom.2.00027X0043-PZ3" srsDimension="2" srsName="urn:ogc:def:crs:EPSG::4326">
     ...
     <gml:featureMember><ef:EnvironmentalMonitoringFacility gml:id="Piezometre.00027X0049.PZ3BIS.2">
            ...
            <ef:legalBackground/>
            <ef:geometry>
                <gml:Point gml:id="Piezometre.geom.2.00027X0049-PZ3BIS" srsDimension="2" srsName="urn:ogc:def:crs:EPSG::4326">
                    <gml:pos>50.9517134740995 2.0233711797075</gml:pos>
                </gml:Point>
            </ef:geometry>
     ...
     <gml:featureMember><ef:EnvironmentalMonitoringFacility gml:id="Piezometre.00035X0029.P1.2">
            ...
            <ef:legalBackground/>
            <ef:geometry>
                <gml:Point gml:id="Piezometre.geom.2.00035X0029-P1" srsDimension="2" srsName="urn:ogc:def:crs:EPSG::4326">
     ...
     <gml:featureMember><ef:EnvironmentalMonitoringFacility gml:id="Piezometre.00035X0045.P1.2">
            ...
            <ef:legalBackground/>
            <ef:geometry>
                <gml:Point gml:id="Piezometre.geom.2.00035X0045-P1" srsDimension="2" srsName="urn:ogc:def:crs:EPSG::4326">
